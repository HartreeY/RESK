...
# Full name: 1d_revised_grid_reflecting_version2_firstpair_noburnin
# ("first-pair approach" in the paper)
# ------------------------------------------------
...
serialize("output/1d/r_gridrefl2for_noburn_$procid-meanf.dat",meanf_world)
